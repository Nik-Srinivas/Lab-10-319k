...
uint32_t Convert(uint32_t input){
	uint32_t result = 0; 								// min value is 0, max value is 2000
	result = (428*input) / 1000 + 136;	// convert ADC result to centimeters based on linreg
  return result;
}
